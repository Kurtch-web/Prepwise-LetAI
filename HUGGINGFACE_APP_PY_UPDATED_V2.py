...
class QuestionRequest(BaseModel):
    ...
    explanation_instruction: Optional[str] = None
...
async def generate_explanation(request: QuestionRequest):
    ...
    - explanation_instruction: custom instruction for explanation style
    ...
    Example request (English):
    {
        ...
        "correct_answer": "B",
        "language": "english",
        "explanation_instruction": "Provide detailed explanations for each choice"
    }
    """
    if model is None or tokenizer is None:
        raise HTTPException(status_code=503, detail="Model not loaded")
    ...
    try:
        ...
        if is_filipino:
            ...
            default_instruction = "Magbigay ng paliwanag para sa lahat ng pagpipilian sa TAGALOG."
            user_instruction = request.explanation_instruction or default_instruction
            ...
            default_instruction = "Provide explanations for all choices."
            user_instruction = request.explanation_instruction or default_instruction
