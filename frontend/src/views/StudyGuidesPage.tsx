  ...
  const getGuideModalData = (guideName: string): GuideModalData => {
    const modalContent: Record<string, GuideModalData> = {
      ...
      'Recommended Books and Textbooks': {
        title: 'Recommended Books and Textbooks',
        slides: [
          {
            type: 'content',
            heading: 'Recommended Books and Textbooks',
            content: 'Good study materials are crucial. The right books explain concepts clearly, provide examples, and help you understand not just memorize. Why quality matters: Poor textbooks confuse more than clarify. Well written books make difficult topics understandable. They provide context, explanations, and examples that lecture notes might miss. This guide recommends books across all LET content areas. Your local bookstore, library, or online retailers (Shopee, Lazada, Amazon) can provide these. Many are available used at discount. Some are available as e books. Libraries often have copies for free. Strategy: Don\'t buy every recommended book. Choose 2-3 that match your learning style. Some people learn better from comprehensive textbooks; others from focused guides. Experiment. Also, you may already own many relevant books from college. Check your shelf first before buying.'
          },
          {
            type: 'content',
            heading: 'General Education and Professional Education Books',
            content: 'For General Education fundamentals: "The Way Things Work" by Bill Nye (accessible science), "A Brief History of Nearly Everything" by Bill Bryson (engaging overview of many topics), "Humankind: A Hopeful History" by Rutger Bregman (understanding human nature and society). For Philippine history and government: "Philippine History by Teodoro Agoncillo" (comprehensive Philippine history), "The Philippine Constitution Explained" (various authors look for recent editions), "Birth of a Nation: The Philippines" by Filipinos in History series. For Professional Education and Pedagogy: "Understanding by Design" by Wiggins and McTighe (curriculum design), "Classroom Management Models" by Landmark books, "Theories of Learning" textbooks (Ormrod, Schunk, or Driscoll editions), "The First Days of School" by Harry Wong (practical classroom management), "Emotional Intelligence in Education" (various authors crucial for understanding student development). For Educational Psychology: "Educational Psychology: Theory and Practice" by Robert Slavin (comprehensive, readable), "How Students Learn" by National Research Council (evidence-based learning), "The Growth Mindset" by Carol Dweck (understanding how students develop). Strategy: Read chapter summaries first. Many textbooks provide summaries that condense key points. If a chapter summary makes sense, you understand the concept. If not, read the full chapter. This saves time while ensuring understanding.'
          },
          {
            type: 'content',
            heading: 'Subject Matter Expertise Books',
            content: 'For English Language and Communication: "The Elements of Style" by Strunk & White (writing rules and clarity), "Advanced Grammar in Use" by Cambridge (comprehensive grammar), "Literature Guides" specific to texts you might encounter (SparkNotes and CliffsNotes provide useful summaries and analyses). For Mathematics: "What is Mathematics?" by Richard Courant (understanding mathematical thinking, not just procedures), "Mathematics content for elementary teachers" textbooks (explains concepts teachers need to know), problem-solving books like "How to Solve It" by Polya (strategy for mathematical problem-solving). For Science: "A Framework for Understanding Science" by National Academies, "Biology" by Campbell and Reece (comprehensive, accessible high school biology), "Chemistry" by OpenStax or similar (clear chemistry explanations), "Physics" by various authors focus on conceptual physics books rather than calculation-heavy ones. For Social Studies: "Philippine Society and Culture" textbooks, "Archaeology or Anthropology of the Philippines," "Southeast Asian History" (gives context for understanding Philippines), "Geography of Southeast Asia and the Philippines." Strategy: Don\'t try to read every book cover-to-cover. Use books as references. When studying a topic, find relevant chapters and read those. Create a "reference library" organized by topic so you can quickly find information. Example: You\'re studying photosynthesis. Open your biology book to photosynthesis chapter. Read it. Make notes. Move on. You don\'t read the whole book; you use it strategically.'
          },
          {
            type: 'content',
            heading: 'Test Preparation Books and Practice Materials',
            content: 'Specific LET preparation books: "LET Comprehensive Reviewer" (various authors publish these search for recent editions), "LET Exam Questions and Answers" (previous exams or practice questions), "Philippine Normal University LET Review Materials" (if available through their publications), "Teachers\' Academy of the Philippines materials" (various prep books). Practice question books: Essential because practicing with actual question types builds both knowledge and test-taking skills. Look for books with: (1) Questions organized by topic (easier to study specific areas), (2) Explanations for all answers (not just right answers understanding why other choices are wrong matters), (3) Recent exam questions if possible (test structure changes over time). Digital practice: Many online platforms offer practice exams. See the Free Educational Resources guide for digital options. Strategy: Spread practice over time rather than doing all at once. If a book has 500 practice questions, don\'t do them all in one sitting. Do 20-30 per day, review mistakes, adjust studying based on what you got wrong. Example: You buy a practice question book with 600 questions. Week 1: Do questions on General Education (100 questions), review, study weak areas. Week 2: Do questions on Professional Education (100 questions), review. This spaced approach prevents overwhelm and enables learning from mistakes.'
          },
          {
            type: 'content',
            heading: 'Digital Resources and Online Books',
            content: 'Many excellent resources are available free or cheap online: Government textbooks: The Department of Education releases free textbooks (search "DepEd Learning Materials"). These align with K-12 curriculum and are high quality. Available in print (sometimes free from schools) and online. OpenStax: Provides free, peer reviewed textbooks (Biology, Chemistry, Physics, Social Sciences, etc.). High quality, constantly updated. Available free online or as inexpensive print versions. Khan Academy: Free video lessons and practice problems across many subjects. Excellent for visual learners. Crash Course: YouTube channel with engaging 10-15 minute videos covering major topics. Educational, entertaining, and free. TED-Ed: Curated educational videos from TED. High quality, accessible. Project Gutenberg: Free public domain books (literature, classic texts on many subjects). Useful for understanding classics and primary sources. Google Scholar: Search for academic papers. Many are available free. Useful for understanding research and advanced topics. Strategy: Combine different resource types. Use a textbook for comprehensive understanding, Khan Academy videos for visual explanation, and practice question books for skill building. Different resources serve different purposes. Example: Learning about plate tectonics. Read textbook chapter (comprehensive). Watch Khan Academy video (visual reinforcement). Read a National Geographic article about specific earthquakes or volcanoes (real world application). Do practice questions (skill building). This multi-source approach creates deep, varied understanding.'
          }
        ]
      },
      'PRC Table of Specifications (TOS)': {
        title: 'PRC Table of Specifications',
        slides: [
          {
            type: 'content',
            heading: 'PRC Table of Specifications (TOS)',
            content: 'The Table of Specifications (TOS) is the official document from the Professional Regulation Commission (PRC) that specifies what will be tested on the LET. It breaks down the exam into content areas, topics, and the percentage of questions for each. Why it is crucial: The TOS is your study guide map. Rather than studying randomly, the TOS shows you exactly what to study and how much emphasis each topic deserves. If the TOS allocates 10% of questions to Assessment of Learning, you know it is a high priority. If it allocates 2% to a minor subtopic, you do not need to study it as deeply. Following the TOS ensures you study what matters most. Many students waste time studying topics that are not heavily tested, then struggle with the core professional education theories that are. Using the TOS prevents this inefficiency. For BSED students, the 2026 TOS places a combined 80% weight on Professional Education and your Major. This means your "map" is heavily weighted toward pedagogy and subject specialization. Relying on the TOS allows you to work smarter by aligning your review with the actual points distribution of the exam.'
          },
          {
            type: 'content',
            heading: 'Understanding TOS Structure',
            content: 'The TOS divides the LET into major content areas for BSED students: General Education (20%), Professional Education (40%), and Subject Matter Expertise in your specific teaching field (40%). Within each area, specific topics are listed with percentages. Example (General Education): English and Filipino 10% (covers grammar, vocabulary, reading comprehension, and literature). Mathematics 5% (covers arithmetic, algebra, geometry, and statistics). Science 5% (covers life science, physical science, and Earth science). Social Studies and ICT 5% (covers history, government, current events, and digital literacy). Each percentage tells you: if there are 150 General Education questions, a specific number will be dedicated to each subtopic based on its weight. Professional Education breakdown: Educational Foundations, Theories, and Ethics 10% (covers psychology, learning theories, and the teaching profession). Curriculum Development and Design 10% (covers understanding curriculum structure and ICT integration). Assessment of Learning 10% (covers evaluation methods, grading, and data interpretation). Child and Adolescent Development 10% (covers diversity, inclusion, and learner behavior). Subject Matter Expertise: This accounts for 40% of your total grade and depends on your specific BSED major such as English, Math, Science, or TLE, covering the depth of content you will teach at the secondary level.'
          },
          {
            type: 'content',
            heading: 'Using TOS for Study Planning',
            content: 'The TOS directly informs your study schedule. Allocate study time proportional to the percentages. Example: If Professional Education and your Major together make up 80% of the exam and you have 400 study hours total, allocate 320 hours to these core areas. Within those hours, allocate proportionally: Professional Education (40% of total = 160 hours) and Subject Matter Expertise (40% of total = 160 hours). The remaining 80 hours should be dedicated to General Education (20% of total). This ensures you are not overstudying the lower weight subjects while underpreparing for the sections that actually determine your license. The TOS also helps identify your priorities. If you are weak in a high percentage topic, prioritize it immediately. If you are weak in a low percentage topic, focus on it minimally. Example: You struggle with Assessment of Learning which is a major part of Professional Education. You are strong in English which is a smaller part of General Education. Strategy: Allocate more than the calculated hours to Assessment of Learning because it is both difficult for you and carries high weight. Allocate slightly less to English because you already have mastery. This strategic allocation based on both difficulty and the 2026 weight distribution optimizes your study time for maximum results.'
          },
          {
            type: 'content',
            heading: 'Content Depth Based on TOS Allocation',
            content: 'The TOS percentage also indicates the depth of knowledge needed. High percentage topics deserve deeper understanding. Low percentage topics need surface level knowledge. Example: If Information Technology is 5% of General Education, you need to understand basic computer concepts but not become an expert in programming or cybersecurity. Your preparation: basic computer literacy, internet navigation, email, word processing, online safety, and file management. That is sufficient for 5% of questions. If Educational Psychology is 10% or more of Professional Education, it warrants deep study. You need to understand learning theories, developmental stages, motivation, assessment, and addressing diverse learners. This deeper knowledge is justified by the higher percentage. Using this principle: Before studying a topic, check its TOS percentage. If high (8% and above), study it comprehensively. Read multiple sources, do many practice questions, and understand the nuances. If medium (3 to 7%), study it adequately. Understand the main concepts and key examples. If low (1 to 2%), study it minimally. Know the definitions and main ideas. Example: Bloom’s Taxonomy is central to education theory and is a major part of Professional Education. Study it thoroughly. The phonetics of a specific language might be 1%. Know it exists and the basic concepts, but do not deep dive. This strategic depth allocation is efficient for BSED students who need to balance GenEd, ProfEd, and their Major.'
          },
          {
            type: 'content',
            heading: 'Aligning Practice Materials with TOS',
            content: 'When you buy practice question books or use online platforms, check whether they align with the official TOS. Questions should: (1) Cover all topics listed in the TOS, not just the popular ones. (2) Allocate questions proportionally to the TOS percentages. If the TOS says 20% of the exam is General Education, roughly 20% of your practice questions should be General Education. (3) Include questions from recent exams if possible. The TOS changes infrequently but it does update. Using outdated practice materials might include topics that are no longer tested. Cross reference your practice questions with the TOS. If you find no practice questions on a topic listed in the TOS, that is a gap. Research that topic and create your own practice questions. If you find many practice questions on a topic with a low TOS percentage, de-emphasize it and focus on high percentage topics. Example: The TOS says Assessment of Learning is 10% of Professional Education. A practice question book has 30 Assessment of Learning questions out of 300 Professional Education questions, which is 10%. That is correct. But if the book has 60 questions on assessment (20%), it is overemphasizing that topic. Use it for practice but do not stress if you get some wrong because the actual exam will emphasize assessment less. Meanwhile, if it has only 10 assessment questions (3%), you have found a gap. You will need to find additional practice questions or create your own to ensure you are ready for that 10% chunk of the board exam. For BSED students, ensuring your practice tests have a strong 40% focus on your Major is the most important alignment check you can perform.'
          },
          {
            type: 'content',
            heading: 'Monitoring Progress Against TOS',
            content: 'Track your progress against the TOS to ensure comprehensive coverage. Method 1: Create a checklist. Copy all TOS topics and check off each as you complete it. Method 2: Create a spreadsheet. List the topics, target number of study hours based on the TOS percentage, actual hours studied, and your practice test score for that specific topic. Method 3: Score practice questions by TOS topic. If the TOS allocates 10% to Assessment of Learning, take all Assessment of Learning practice questions and track your percentage correct. This shows which TOS topics are strong and which need more work. Example tracking: TOS Topic: Child and Adolescent Development (part of Professional Education, 10% of overall exam). Plan: 40 hours of study. Progress: 20 hours completed. Confidence: Low (scored 65% on practice questions). Action: Allocate extra time to developmental theories like Piaget and Vygotsky before moving on. TOS Topic: Digital Literacy (part of Information Technology, 5% of General Education, so 1% of overall exam). Plan: 4 hours of study. Progress: 2 hours completed. Confidence: High (scored 95% on practice questions). Action: Move on immediately because this is already solid. This tracking ensures no topic is left behind and reveals exactly where you need to focus your energy. For BSED students, focus your tracking on the 80% weight areas of Professional Education and your Major to ensure you reach the passing mark.'
          }
        ]
      },
        ...
        slides: [
          {
            ...
            content: 'Quality learning materials don\'t have to be expensive. Many excellent free resources exist online and offline. Why use free resources: They save money (important for students on tight budgets). They offer variety different sources explain concepts differently, and variety aids learning. Some free resources (like government textbooks) are government-endorsed quality. This guide highlights reliable, high quality free resources for LET preparation. Strategy: Use free resources strategically. They might not be perfectly organized for LET prep, so you need to identify relevant content. Combining multiple free resources (a textbook from one source, practice questions from another, videos from a third) creates a comprehensive preparation package at zero cost.'
          },
          {
            type: 'content',
            heading: 'Government and Official Free Resources',
            content: 'Department of Education (DepEd) Learning Materials: The Philippine DepEd publishes free textbooks aligned with K-12 curriculum. These are available online at depedlearningresources.com or through schools. They cover: General Education subjects (Math, Science, English, Filipino, Social Studies), values education, and other K-12 content. Quality: Government-endorsed, align with Philippine standards, written by educators. Availability: Free online downloads, sometimes available in print through schools. How to use: These textbooks are designed for K-12 students, so some might be simpler than LET requirements. Use them as foundations, then supplement with more advanced materials. Professional Regulation Commission (PRC) Website: The PRC publishes guidelines, previous exam announcements, and sometimes sample questions. Visit prc.gov.ph for official information. National Academy of Science and Technology (NAST) Publications: Sometimes publishes science education materials. Check their website. Bureau of Internal Revenue or other government agencies: Various government bureaus publish materials relevant to civics and government topics. These are often available free through their websites. Strategy: Government resources are reliable but not always perfectly suited to LET prep. Use them as foundations. Example: Study Philippine government structure using a DepEd Social Studies textbook. Then review the TOS to ensure you\'re learning at the depth required for LET.'
          },
          {
            type: 'content',
            heading: 'Online Learning Platforms and Video Resources',
            content: 'Khan Academy (khanacademy.org): Free video lessons and practice exercises in math, science, history, and more. High quality explanations. No sign-up required (though signing up allows progress tracking). Particularly strong in math and science. Coverage: K-12 and some college level content. How to use: Search for specific topics. Watch videos; do practice problems. Excellent for visual learners and for reviewing topics you found confusing. Crash Course (YouTube channel): Engaging, high quality educational videos (10-15 minutes each) covering history, biology, chemistry, world history, literature, and more. Free on YouTube. Content: "Crash Course World History," "Crash Course Psychology," "Crash Course Literature," etc. How to use: Supplement textbook learning with videos. Seeing concepts explained dynamically sometimes clarifies what reading didn\'t. TED-Ed (ed.ted.com): Curated educational videos by experts. Many topics relevant to education, social sciences, science. Short and engaging. Quality: Very high. How to use: Search for topics, watch videos, engage with lesson materials. OpenStax (openstax.org): Free, peer-reviewed textbooks in math, science, social sciences, humanities. Available online and as inexpensive print copies. Content: High school to college level. How to use: Available by subject and level. Find relevant textbooks and read chapters on topics you\'re studying. Coursera, edX, FutureLearn: Free access to some courses. While some require payment for certificates, course materials are often available free. Various university courses in education, science, social sciences. How to use: Audit courses relevant to your teaching field. YouTube Educational Channels: Beyond Crash Course, many channels publish educational content. Examples: CrashCourse Kids (science for younger learners good for understanding at an accessible level), Veritasium (science explained), Kurzgesagt (complex topics made simple with excellent visuals). Strategy: Use videos to supplement reading. Don\'t rely on videos alone combine them with text study and practice problems.'
          },
          {
            type: 'content',
            heading: 'Open Source Textbooks and Publications',
            content: 'OpenStax CNX (cnx.org): Open educational resource platform with free textbooks and course materials. Coverage: STEM, social sciences. Quality: Peer-reviewed. Project Gutenberg (gutenberg.org): Free public domain books, including classic literature, primary historical documents, and reference books. How to use: For literature study, access original texts. For history study, read primary sources. For general knowledge, access classic educational books. LibreTexts (libretexts.org): Free, peer-reviewed textbooks across many subjects. Chemistry, math, science, social sciences. High quality. MERLOT (merlot.org): Repository of open educational resources including textbooks, simulations, and interactive materials. Saylor Academy (saylor.org): Free college level courses with course materials, readings, and assessments. Covers education, social sciences, humanities. Internet Archive (archive.org): Vast digital library. While primarily an archive, many educational resources are available. BCcampus Open Education (bccampus.ca): Open textbooks for various subjects. Available free online. Strategy: Combine multiple open resources. One might explain a topic in a way that clicks for you; another might provide better examples. Use 2-3 sources to understand each major topic.'
          },
          {
            type: 'content',
            heading: 'Subject-Specific Free Resources',
            content: 'Mathematics: Khan Academy (excellent for math), IXL Math (some free content), Brilliant.org (interactive problem-solving, limited free content), PatrickJMT (YouTube channel with math tutorial videos). Science: Biology Online (biologyonline.org free encyclopedia of biology), PhET Simulations (phet.colorado.edu free interactive science simulations), National Geographic (educational articles), BBC Learning (bbc.com/learning science and nature content). English and Literature: SparkNotes (sparknotes.com free study guides and summaries), Cliff Notes summaries (free on some sites), Project Gutenberg (access to original texts), YouTube literature channels (various educators explaining literature). History and Social Studies: Primary Source Collections through Library of Congress (loc.gov), National Archives (archives.gov), HistoryMaryland and similar state history sources. Khan Academy World History. Geography: National Geographic, Google Earth (interactive geography), OpenStreetMap. Filipino Language: Diksyunaryo.net (Filipino-English dictionary), Philippine focused cultural websites. Information Technology: Codecademy (some free content), Khan Academy Computer Science, W3Schools (for web basics). Strategy: For each subject area, find 1-2 quality free resources. Example: Mathematics Khan Academy videos plus practice problems. Science Khan Academy plus BBC Learning for broad understanding. Literature SparkNotes summaries plus original texts from Project Gutenberg. This combination is comprehensive and free.'
          },
          {
            type: 'content',
            heading: 'Local and Community Resources',
            content: 'Library Resources: Public libraries and university libraries offer: Physical and digital textbooks, reference materials, databases with academic journals, computers for accessing online resources, sometimes LET prep guides or education materials. Many libraries also offer free WiFi. How to use: Get a library card. Research books you\'re interested in. Many libraries allow online access to databases and digital books. Librarians can help you find relevant materials. Free Workshops and Seminars: Education departments, universities, and civic organizations sometimes offer free workshops on education topics. These can supplement your self-study. Online Communities and Forums: LET Philippines Facebook group, Reddit communities for LET takers, teacher forums. These communities share resources, study tips, and practice questions. Free Teacher Networks: Teachers\' organizations sometimes publish materials and resources for members. Check your region\'s teachers\' association. College/University Resources: If you recently graduated, contact your alma mater. Many universities allow alumni to access libraries and sometimes offer free LET prep seminars. Strategy: Explore local resources first. Your nearest library, local teachers\' organization, and community are closest resources. Combine them with online resources for comprehensive preparation. Example: Borrow textbooks from library. Find videos online. Join online community for questions and discussion. This combination is comprehensive and leverages both local and online resources.'
          }
        ]
      },
      'Official PRC Guidelines': {
        title: 'Official PRC Guidelines',
        slides: [
          {
            type: 'content',
            heading: 'Official PRC Guidelines',
            content: 'The Professional Regulation Commission (PRC) oversees the Licensure Examination for Teachers (LET). They publish official guidelines explaining the exam format, registration process, testing rules, and what to expect. Why it matters: Official guidelines prevent confusion and ensure you\'re prepared for actual exam conditions. Many students are surprised or stressed on exam day because they didn\'t know what to expect. Knowing the official guidelines ensures no surprises. You\'ll know what to bring, what\'s allowed, how the test is scored, and what happens after. This guide summarizes key PRC guidelines. You should download and read the official complete guidelines from prc.gov.ph.'
          },
          {
            type: 'content',
            heading: 'Exam Format and Structure',
            content: 'According to PRC guidelines, the LET format: Test Duration: 8 hours total for the full exam. Typically held on a Saturday or Sunday. Morning session (roughly 3-4 hours) covers General Education and Professional Education. Afternoon session (roughly 3-4 hours) covers Subject Matter Expertise. A lunch break separates morning and afternoon. Question Format: All multiple choice. Five options per question (A, B, C, D, E). Questions are scenario-based and conceptual, testing understanding not just memorization. Total Questions: Approximately 200 questions (varies slightly by year and exam administration). Scoring: Each correct answer is one point. No penalty for guessing. Your score is based on number correct. Passing Score: Approximately 60-70% depending on the exam administration. Exact passing score is set after the exam based on standard-setting procedures. You receive: Percentile rank (how you compare to other test-takers), scaled score (adjusted for test difficulty), rating in each content area. Content Areas: General Education (approximately 25-30%), Professional Education (approximately 20-25%), Subject Matter Expertise (40-50%, depends on your field). Strategy: Knowing the format helps you prepare accurately. Since it\'s all multiple choice, practice with multiple choice questions. Since there\'s no penalty for guessing, if unsure, eliminate wrong answers and guess strategically rather than leaving questions blank.'
          },
          {
            type: 'content',
            heading: 'Registration and Important Documents',
            content: 'Registration Process: You register online through prc.gov.ph or at designated test centers. Typically, registration opens 2-3 months before the exam. Registration deadline is usually 2-3 weeks before the exam. Costs: Registration fee (approximately ₱600-800, subject to change). You pay through online banking or in-person at test centers. Documents Required for Registration: Valid government issued ID (passport, driver\'s license, national ID), TIN (Taxpayer Identification Number), educational attainment proof (bachelor\'s degree from an accredited institution). Some documents may need to be submitted during registration; others at the test center. Notice of Admission (NOA): After registration, you receive an NOA (electronically or in print). This must be brought to the test center. It contains your registration details, test center location, date and time, and exam instructions. Pre-exam Checklist: 1 week before: Confirm receipt of NOA. Check test center location and directions. 2-3 days before: Prepare required documents and materials. Day before: Get adequate sleep. Morning of exam: Wake early. Eat breakfast. Bring NOA, valid ID, 2 No. 2 pencils, black ballpen, simple calculator (if allowed). Arrive 30 minutes early. Strategy: Don\'t lose your NOA. Make copies. Confirm location and time well in advance. No surprises on exam day.'
          },
          {
            type: 'content',
            heading: 'Test Center Rules and What\'s Allowed',
            content: 'At the Test Center: Arrive 30 minutes before exam start time. Late arrivals may not be admitted. Bring required documents and materials. Leave phones, watches, and other electronics at home or in a safe place (not allowed in testing area). No calculators except basic arithmetic calculators (check current guidelines). Permitted: No. 2 pencils (bring 2-3), eraser, black ballpen, NOA, valid ID. Not Permitted: Phones, smartwatches, computers, calculators (graphing or scientific), notes, textbooks, dictionaries, unauthorized devices. Prohibited Conduct: Talking with other test-takers during exam. Leaving the testing area without permission. Using unauthorized materials. Copying from others. Helping or attempting to help others. Attempting to alter your answer sheet. Eating during the exam (except during lunch break). These violations result in exam cancellation and may result in disqualification from future LETs. Test Administration: Proctors are present during entire exam. They read instructions. They monitor for violations. They collect answer sheets. Your answer sheet is machine-scored. You do not get immediate feedback. Results are typically released 2-3 weeks after the exam. Strategy: Understand rules well before exam day. Avoid violations which would negate months of studying. Bring exactly what\'s allowed and nothing more to avoid confusion.'
          },
          {
            type: 'content',
            heading: 'Results, Score Reports, and License Application',
            content: 'Results Release: Results are typically released 2-3 weeks after the exam. You can check results on prc.gov.ph using your registration details. Results show: Overall rating (Pass/Fail), Percentile rank (where you stand among test-takers), Scaled score, Ratings in each content area (General Education, Professional Education, Subject Matter Expertise), Detailed breakdown by topic (sometimes). Score Interpretation: If you pass, your rating is typically reported as a percentage or scale (e.g., 72%). This indicates your performance. A score of 75% is significantly better than 60% even though both pass. Higher scores can be important for job  some employers prefer higher scores. Ratings in each content area show your strengths and weaknesses. If you scored 85% in Professional Education but 55% in Subject Matter Expertise, you understand teaching methods well but need more content knowledge. License Application: If you pass, you can apply for a teaching license (Professional Certificate) through PRC. You submit proof of passing, pay a fee, and receive your certificate. With the certificate, you can legally teach in the Philippines. If you fail: You can retake the exam. PRC typically allows retakes after 2 months (schedule may vary). There\'s no limit to retakes, but you must pay registration fee each time. Strategy: Whether you pass or fail, analyze your score report. Understanding your strengths and weaknesses guides your next steps either applying for your license or identifying study areas for retake.'
          },
          {
            type: 'content',
            heading: 'Special Situations and Accommodations',
            content: 'Test Postponement: If you cannot test on your scheduled date due to emergencies, you can request postponement. Submit requests early. Availability of future exams: LET is typically administered twice yearly. Persons with Disabilities: PRC provides accommodations such as extended time, large print materials, separate testing room, reader assistance if needed. Request accommodations during registration with supporting documentation. Individuals from Other Countries: Non Filipinos can take LET if they have proper credentials. Requirements and process vary. Contact PRC for specifics. Results Verification: If you believe your score is incorrect, you can request score verification through PRC. This is rarely successful (machines are accurate) but is an option. License Replacement: If you lose your Professional Certificate, PRC can issue a replacement. Submit application and fee. Continuing Education and License Renewal: After receiving your license, you must renew it periodically (typically every 3 years). Renewal requires completion of continuing professional development hours. PRC publishes requirements. Strategy: Plan for retakes if needed. Know the exam schedule so you can register for the next available exam if you don\'t pass. Understand your rights regarding accommodations and appeals. PRC aims to be fair; use their systems if you have legitimate concerns.'
          }
        ]
      },
      'Past Exam Question Collections': {
        title: 'Past Exam Question Collections',
        slides: [
          {
            type: 'content',
            heading: 'Past Exam Question Collections',
            content: 'Past LET exam questions are invaluable study resources. Why: They show the exact types of questions you\'ll face. They reveal what topics are frequently tested (more important to study). They help calibrate your preparation level. Practicing with past questions builds test-taking familiarity and confidence. Scoring well on past questions predicts exam performance. Some studies show that students who score 75%+ on past exam questions have 80-90% chance of passing the actual exam. Where to Find Past Questions: Some LET prep books include past exam questions. Search "LET Exam Questions Philippines" or "LET Board Exam Questions" online. Some education websites publish collected questions. Teachers\' organizations sometimes share compiled questions. Online communities for LET takers often share question banks. PRC sometimes publishes sample questions on their website. Strategy: Collect multiple sets of past questions. Different sources might have different compilations. Practice systematically by subject, then mixed, then timed.'
          },
          {
            type: 'content',
            heading: 'Using Past Questions Effectively',
            content: 'Phase 1 (Learning Phase): Take past questions on a specific topic after you\'ve studied that topic. Example: After studying photosynthesis, take 10 questions about photosynthesis. If you score poorly, it shows your understanding is incomplete. Review the topic, then retake similar questions. Phase 2 (Mixed Practice): After studying each major topic, take mixed questions combining topics. Example: 10 questions on science (mix of photosynthesis, respiration, ecology, etc.). This reveals whether you can identify which concept a question is asking about. Phase 3 (Timed Practice): Take full-length practice exams under timed conditions (similar to actual exam). Morning session: 3-4 hours, 100 questions. Lunch. Afternoon session: 3-4 hours, 100 questions. Score yourself. Analyze mistakes. Phase 4 (Targeted Review): Based on phase 3 mistakes, identify weak areas. Intensively practice those topics. Take another full-length exam after a week. Compare scores. Track improvement. Strategy: Don\'t just take tests and move on. Analyze every mistake. For each incorrect answer: What concept did it test? Why did you miss it? Did you misread the question? Not understand the concept? Use wrong reasoning? Address the root cause. This analysis is where real learning happens.'
          },
          {
            type: 'content',
            heading: 'Analyzing and Learning from Past Questions',
            content: 'For each incorrect answer, ask: Question Understanding: Did I understand what the question asked? If no, re-read the question slowly and identify what it\'s asking. Concept Knowledge: Did I understand the concept being tested? If no, review that concept in a textbook. Reasoning Error: Did I understand the concept but apply it incorrectly? If yes, understand the error and correct your reasoning. Test-Taking Error: Did I misread an answer choice or eliminate the right answer? If yes, be more careful in reading. Strategy: Keep a "mistake log." When you get a question wrong, write: (1) Question number, (2) Concept tested, (3) Your answer and why, (4) Correct answer, (5) Why the correct answer is right, (6) Why your answer was wrong, (7) How you\'ll avoid this error next time. Example entry: Question 45: Concept Photosynthesis energy source. I selected: "All organisms require photosynthesis to survive" because I thought photosynthesis was universal. Correct answer: "Plants use light energy to produce chemical energy in the form of glucose" because the question specifically asked about what photosynthesis is. My error: I confused a true statement with the correct answer to the specific question. Next time: Be more careful to answer what\'s asked, not just select any true statement. This log is a gold mine. Review it regularly. You\'ll stop making the same mistakes.'
          },
          {
            type: 'content',
            heading: 'Building a Question Bank',
            content: 'Compile your own question bank by: (1) Collecting past questions from multiple sources. (2) Organizing them by topic and subtopic. (3) Labeling difficulty level (Easy, Medium, Hard). (4) Noting sources. Digital organization: Create a spreadsheet with columns: Question Number, Text, Topic, Difficulty, Your Answer, Correct Answer, Explanation. Use Google Sheets for accessibility from any device. Physical organization: Index cards or notebooks organized by topic. Digital apps: Anki, Quizlet, or similar apps let you create digital flashcards and quizzes. Import questions into these apps for spaced repetition practice. Building your bank: Week 1-2: Collect all obtainable past questions. Organize them. Week 3-6: As you study each topic, include relevant questions in your bank. Week 7+: Use your bank for daily practice. By exam time, you\'ve reviewed each question multiple times. Strategy: Your question bank is customized for you. You know which topics are covered and at what depth. You can practice weak areas repeatedly. This personalization makes preparation efficient. Example: You realize you consistently get ecology questions wrong. Search your bank for all ecology questions (maybe 20). Practice them daily for a week. Score tracking: When you re-practice the same question, you know if you\'ve improved. If you scored 50% on ecology questions week 1, and 85% week 2, you know the extra practice worked.'
          },
          {
            type: 'content',
            heading: 'Practice Exam Strategies',
            content: 'Taking a full practice exam: Give yourself 3-4 hours for morning session, break, then 3-4 hours for afternoon session. Simulate test conditions: Quiet room, no interruptions, no notes or books. Do it in one day if possible, like the real exam. After the exam: Score yourself (score answer key). Don\'t look at correct answers until scored. Calculate your score: Total correct ÷ total questions × 100%. If 150 out of 200 correct, your score is 75%. Analyze results: Overall score. Score by major area (General Ed, Professional Ed, Subject expertise). Score by topic within each area. Questions you were unsure about vs. got wrong. Time analysis: Did you finish in time? Did you rush through questions? Use the results to guide further study. Example: You score 68% overall (below passing 70%). Breakdown: General Ed 72%, Professional Ed 65%, Subject Expertise 65%. Subject areas are weak. Focus your remaining study time on those. After 1-2 weeks of focused study on Subject Expertise, take another practice exam. Ideally, score improves. Tracking progression: Keep a log of all practice exams. Date, overall score, breakdown by area. Seeing improvement motivates you. If scores plateau, it signals you need a different study approach. Example progression: Exam 1 (week 3): 62%. Exam 2 (week 5): 68%. Exam 3 (week 7): 72%. This upward trend indicates good progress.'
          },
          {
            type: 'content',
            heading: 'Online Practice Platforms and Question Banks',
            content: 'Several online platforms offer LET practice questions: LET Test Prep Websites: Some websites compile past questions and offer them for free or subscription-based access. Search for "LET practice questions online Philippines." Quizlet: Create your own decks or find existing LET decks. Not all are high quality, but useful ones exist. Use for quick review. Kahoot: Gamified quizzes on various topics. Some teachers create LET-specific Kahoots. Fun way to practice. Google Forms: Some education groups share practice questions through Google Forms (free to take). Facebook Groups: LET Philippines groups sometimes have question banks or links to questions shared by members. YouTube Channels: Some creators post practice questions with explanations. Subscription Services: Some paid education platforms offer comprehensive practice question banks with explanations. Examples: Udemy courses with practice questions (if available for LET), specialized LET prep apps. Strategy: Use free platforms first. If they cover your needs, no need to pay. If you find gaps, consider paid services. A $10-30 investment in a good question bank can be worthwhile if it helps you score higher. Example: Use Quizlet and free online questions to practice. If you feel weak in specific areas, pay for a comprehensive question bank focused on those areas. This targeted, cost-effective approach maximizes value.'
          }
        ]
      },
        ...
        slides: [
          {
            ...
            content: 'The LET uses many specialized terms. Understanding terminology is crucial for comprehension. A term you don\'t understand makes questions difficult or impossible. Many students miss questions because they didn\'t understand a word, not because they didn\'t know the concept. This glossary covers the most important LET-relevant terms organized by area: Educational Psychology and Learning Theory, Pedagogy and Teaching Methods, Assessment and Evaluation, Curriculum and Content areas. For each term, you\'ll find a clear definition and sometimes an example. Use this glossary as: (1) A reference when you encounter unfamiliar terms while studying. (2) A study tool read through and quiz yourself on definitions. (3) A check for understanding if you can\'t explain a term clearly, you don\'t fully understand it. Strategy: Create flashcards from this glossary. Study them regularly. By exam time, you\'ll recognize and understand every term you encounter.'
          },
          {
            type: 'content',
            heading: 'Educational Psychology and Learning Theory Terms',
            content: 'Accommodation (Piaget): The process of adjusting mental schemas to fit new information that doesn\'t fit existing schemas. Example: A child believes "dogs are animals" and learns "whales are also animals" and adjusts their concept. Assimilation (Piaget): Interpreting new information using existing schemas. Example: A child sees a cow and calls it a dog because it fits their "four-legged animal" schema. Behavioral Conditioning: Learning through associations between stimuli and responses. Classical conditioning (Pavlov): Pairing an unconditioned stimulus with a neutral stimulus until the neutral stimulus triggers the response. Operant conditioning (Skinner): Behavior shaped by consequences rewards increase behavior, punishments decrease it. Cognitive Load: The amount of mental effort required to process information. High cognitive load impairs learning. Constructivism: The theory that learners actively construct understanding through experience, not passively receive it. Zone of Proximal Development (Vygotsky): The gap between what a learner can do independently and what they can do with help. Intrinsic Motivation: Desire to learn because the activity is inherently interesting or important. Extrinsic Motivation: Desire to learn due to external rewards or avoiding punishment. Fixed Mindset: Believing abilities are static. Growth Mindset: Believing abilities can develop through effort. Multiple Intelligences: Howard Gardner\'s theory that intelligence includes linguistic, logical-mathematical, spatial, bodily-kinesthetic, musical, interpersonal, intrapersonal, and naturalistic intelligences.'
          },
          {
            type: 'content',
            heading: 'Pedagogy and Teaching Methods Terms',
            content: 'Differentiated Instruction: Adjusting instruction for students with different learning needs, levels, and styles. Scaffolding: Providing support that gradually decreases as students gain competence. Example: Teacher fully explains a concept, then models how to solve problems, then guides students through problems, then students practice independently. Inquiry-Based Learning: Students learn by asking questions, investigating, and discovering answers rather than being told. 5E Model: Engage (hook student interest), Explore (students investigate), Explain (teacher provides concept), Elaborate (students extend learning), Evaluate (assess understanding). Cooperative Learning: Students work in groups to achieve common goals. Each member is responsible for their part and the group\'s success. Classroom Management: Strategies for organizing the physical environment, establishing routines, and managing behavior to create a learning environment. Positive Reinforcement: Adding a desirable consequence after a behavior to increase it. Negative Reinforcement: Removing an undesirable consequence after a behavior to increase it. (Different from punishment.) Modeling: Demonstrating the desired behavior so students can learn by observing. Cooperative learning is a classroom management strategy involving structured group work. Standards-Based Instruction: Teaching aligned with specific learning standards (what students should know and be able to do). Backward Design: Planning instruction by starting with desired learning outcomes and working backward to determine instruction and assessment. Bloom\'s Taxonomy: Classification of learning objectives from simple (Remember) to complex (Create): Remember, Understand, Apply, Analyze, Evaluate, Create.'
          },
          {
            type: 'content',
            heading: 'Assessment and Evaluation Terms',
            content: 'Formative Assessment: Assessment during learning to check understanding and guide instruction. Examples: quizzes, observations, exit tickets. Used to improve teaching and learning. Summative Assessment: Assessment after learning to measure overall achievement. Examples: unit tests, final exams. Used to assign grades and evaluate program. Authentic Assessment: Assessing real world tasks and meaningful performance, not just test scores. Examples: student projects, portfolios, presentations. Reliability: Consistency of assessment results. If you retake a reliable test, you\'d get similar scores. Validity: Whether an assessment measures what it claims to measure. A test is valid if it truly assesses the intended learning. Rubric: A scoring guide that describes criteria for different performance levels. Helps provide objective feedback and grades. Scoring: Converting performance to numerical or letter grades. Percentile: The percentage of test-takers scoring at or below a score. If you score at the 75th percentile, 75% of test-takers scored your score or lower. Standard Deviation: A measure of spread in test scores. Large standard deviation means scores vary widely. Small means scores cluster closely. Item Analysis: Examining individual test questions to see if they effectively differentiate between high and low performers. Questions many students get wrong might be confusing or poorly worded. Backward Design: Planning by starting with desired outcomes and working backward to determine assessment and instruction. Norm-Referenced: Comparing a student\'s performance to other students. Example: percentiles. Criterion-Referenced: Comparing performance to a standard. Example: 80% on test indicates mastery if standard is 80%.'
          },
          {
            type: 'content',
            heading: 'Curriculum and Content Terms',
            content: 'Curriculum: Everything students learn in school, including planned and unplanned learning. Hidden Curriculum: Unintended lessons about values, behavior, and social structures learned through school environment and interactions. Scope: The breadth of content covered in curriculum. Sequence: The order in which content is taught. Alignment: How curriculum aligns with standards and with other curriculum components (one level to next). Rigor: The depth and complexity of content. Culturally Responsive Teaching: Recognizing and valuing students\' cultural backgrounds and incorporating them into instruction. Differentiation: Modifying instruction to meet diverse learner needs. Schema: An organized set of beliefs and knowledge about a concept. Example: A schema for "dog" includes characteristics like four legs, barks, is a pet. Transfer of Learning: Applying learning from one situation to another. Example: Using math skills learned in class in real world situations. Metacognition: Thinking about thinking. Awareness of one\'s own learning processes and strategies. Constructivist Learning: Students actively construct understanding through experience and interaction. Observational Learning: Learning by observing others. Example: A student learns how to solve problems by watching the teacher solve them. Retention: How much information is remembered after learning. Distributed Practice (Spacing): Practicing over time with gaps between sessions. More effective than massed practice (cramming). Social Learning Theory (Bandura): Learning occurs through observation, imitation, and modeling, influenced by social context.'
          }
        ]
      }
    };
