        ...
        slides: [
          {
            ...
            content: 'The Table of Specifications (TOS) is the official document from the Professional Regulation Commission (PRC) that specifies what will be tested on the LET. It breaks down the exam into content areas, topics, and the percentage of questions for each. Why it\'s crucial: The TOS is your study guide map. Rather than studying randomly, the TOS shows you exactly what to study and how much emphasis each topic deserves. If the TOS allocates 15% of questions to photosynthesis, you know it\'s important. If it allocates 2% to a topic, you don\'t need to study it deeply. Following the TOS ensures you study what matters most. Many students waste time studying topics that aren\'t heavily tested, then struggle with topics that are. Using the TOS prevents this inefficiency.'
          },
          {
            type: 'content',
            heading: 'Understanding TOS Structure',
            content: 'The TOS divides the LET into major content areas: General Education (25-30%), Professional Education (20-25%), and Subject Matter Expertise in your specific teaching field (40-50%). Within each area, specific topics are listed with percentages. Example (General Education): English Language and Communication—15% (covers grammar, vocabulary, reading comprehension, writing). Mathematics—10% (covers arithmetic, algebra, geometry, statistics). Science—15% (covers life science, physical science, Earth science). Social Studies—10% (covers history, government, current events). Information Technology—5% (covers computer literacy, digital skills). Each percentage tells you: if there are 100 General Education questions, 15 are about English Language, 10 about Mathematics, etc. Professional Education breakdown: Educational Foundations and Theories—15% (psychology, learning theories, pedagogy). Curriculum Development and Design—10% (understanding curriculum structure and design). Assessment of Learning—8% (evaluation methods, grading, data interpretation). Social Dimensions of Education—7% (diversity, inclusion, community). Subject Matter Expertise: This depends on your teaching field (Math, Science, English, etc.), but typically covers content you\'d teach in your subject area at depth. Strategy: Download the official TOS from PRC website or your test center. Print it and highlight topics. As you study, cross off topics you\'ve mastered. This visual progress motivates you and ensures comprehensive coverage.'
          },
          {
            type: 'content',
            heading: 'Using TOS for Study Planning',
            content: 'The TOS directly informs your study schedule. Allocate study time proportional to the percentages. Example: If General Education is 30% of the exam and you have 300 study hours total, allocate 90 hours to General Education. Within those 90 hours, allocate proportionally: English (15% of 90 = 13.5 hours), Mathematics (10% of 90 = 9 hours), Science (15% of 90 = 13.5 hours), Social Studies (10% of 90 = 9 hours), Information Technology (5% of 90 = 4.5 hours). This ensures you\'re not overstudying easy subjects while underpreparing hard ones. TOS also helps identify your priorities. If you\'re weak in a high-percentage topic, prioritize it. If you\'re weak in a low-percentage topic, focus minimally. Example: You struggle with mathematics, which is 10% of General Education. You\'re strong in English, which is 15%. Strategy: Allocate more than 9 hours to mathematics because it\'s harder for you. Allocate slightly less than 13.5 hours to English because you\'re strong. This strategic allocation based on difficulty and importance optimizes your study time.'
          },
          {
            type: 'content',
            heading: 'Content Depth Based on TOS Allocation',
            content: 'The TOS percentage also indicates the depth of knowledge needed. High-percentage topics deserve deeper understanding. Low-percentage topics need surface-level knowledge. Example: If Information Technology is 5% of General Education, you need to understand basic computer concepts but not become an expert in programming or cybersecurity. Your preparation: basic computer literacy, internet navigation, email, word processing, online safety, file management. That\'s sufficient for 5% of questions. If Educational Psychology is 15% of Professional Education, it warrants deep study. You need to understand learning theories, developmental stages, motivation, assessment, addressing diverse learners. This deeper knowledge is justified by the higher percentage. Using this principle: Before studying a topic, check its TOS percentage. If high (8%+), study it comprehensively—read multiple sources, do many practice questions, understand nuances. If medium (3-7%), study it adequately—understand main concepts and key examples. If low (1-2%), study it minimally—know definitions and main ideas. Example: Bloom\'s Taxonomy is central to education theory, likely 4-5% of Professional Education. Study it thoroughly. The phonetics of a specific language might be 1%. Know it exists and basic concepts, but don\'t deep dive. This strategic depth allocation is efficient.'
          },
          {
            type: 'content',
            heading: 'Aligning Practice Materials with TOS',
            content: 'When you buy practice question books or use online platforms, check whether they align with the official TOS. Questions should: (1) Cover all topics listed in TOS, not just popular ones. (2) Allocate questions proportionally to TOS percentages. If TOS says 15% of General Education is English, roughly 15% of General Education practice questions should be English. (3) Include questions from recent exams if possible. TOS changes infrequently but does update. Using outdated practice materials might include topics no longer tested. Strategy: Cross-reference practice questions with the TOS. If you find no practice questions on a topic listed in TOS, that\'s a gap. Research that topic and create your own practice questions. If you find many practice questions on a topic with low TOS percentage, de-emphasize it and focus on high-percentage topics. Example: TOS says "Assessment of Learning" is 8% of Professional Education. A practice question book has 30 "Assessment of Learning" questions out of 300 Professional Education questions, which is 10%. That\'s about right. But if the book has 50 questions on assessment (17%), it\'s overemphasizing that topic. Use it for practice but don\'t stress if you get some wrong—the exam will emphasize assessment less. Meanwhile, if it has only 10 assessment questions (3%), you\'ve found a gap. You\'ll need to find additional practice questions or create your own.'
          },
          {
            type: 'content',
            heading: 'Monitoring Progress Against TOS',
            content: 'Track your progress against the TOS to ensure comprehensive coverage. Method 1: Create a checklist. Copy all TOS topics and check off each as you complete it. Method 2: Create a spreadsheet. List topics, target number of study hours (based on TOS percentage), actual hours studied, and practice test score for that topic. Method 3: Score practice questions by TOS topic. If TOS allocates 15% to English Language, take all English Language practice questions and track your percentage correct. This shows which TOS topics are strong and which need more work. Example tracking: TOS Topic: Photosynthesis (part of Life Science, 8% of Science, so maybe 1.2% of overall exam). Plan: 3-4 hours of study. Progress: 2 hours completed. Confidence: Low (scored 65% on practice questions). Action: Allocate extra time to photosynthesis before moving on. TOS Topic: Computer Maintenance (part of Information Technology, 5% of General Education, so 1.5% of overall exam). Plan: 1 hour of study. Progress: 1 hour completed. Confidence: High (scored 90% on practice questions). Action: Move on; this is solid. This tracking ensures no topic is left behind and reveals where you need to focus.'
          }
        ]
      },
